    ...
    emit_class: function () {
        ...
        data: function () {
            return {
                ...
                classes_choisies: { items: []},
                c: '',
                img_guerrier: img_guerrier,
                img_mage: img_mage,
                img_voleur: img_voleur,
                img_pretre: img_pretre,
                img_illusionniste: img_illusionniste,
                img_ranger: img_ranger,
                img_druide: img_druide,
                img_paladin: img_paladin,
                img_assassin: img_assassin,
                img_barde: img_barde
            }
        }
    }
